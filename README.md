...
The plugin opens directly to the document page with local Word/PDF/JSON exports. No login, registration, Firebase, localhost or self-managed server is required. See [plugin setup](figma-plugin/README.md).
