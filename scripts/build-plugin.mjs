...
for (const dir of ['figma-plugin/', 'figma-plugin/figdoc/']) {
  ...
  manifest.networkAccess = { allowedDomains: ['https://figdoc-e0f98.firebaseapp.com', 'https://identitytoolkit.googleapis.com', 'https://securetoken.googleapis.com'], reasoning: 'Google sign-in via Firebase Authentication and the hosted Figdoc sign-in page. Design exports stay local.' }
